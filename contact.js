...
const EMAILJS_PUBLIC_KEY = "yZXFdYQJbL-EQ1uAO";
const EMAILJS_SERVICE_ID = "service_mvyzqts";
const EMAILJS_TEMPLATE_ID = "template_oirlie4";        // correo que te llega a ti
const AUTOREPLY_TEMPLATE_ID = "";                       // vacío: el auto-reply ya lo maneja EmailJS (vinculado en el dashboard)
